...
<div className='flex flex-row flex-wrap gap-2 justify-evenly mb-5'>
        ...
        <div className='flex flex-col pt-5 xl:pt-0 items-center justify-center gap-2'>
            <img className='h-[120px] w-[120px] xl:h-[180px] xl:w-[180px] rounded-full' src={logo} alt="" />
        ...
        <div className='flex flex-col  items-center text-white gap-2 xl:gap-5'>
            ...
            <div className='flex flex-wrap justify-center items-center flex-row gap-2 text-xl font-semibold'>
              <h1>Shrayanendra Nath Mandal</h1>
             <h1 className='hover:text-slate-500 cursor-pointer'>8337045160</h1>
              </div>
