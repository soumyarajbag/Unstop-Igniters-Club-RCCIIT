...
const EventCard = ({key , index , name , photos , date , description , image , count , winners , venue , coordinator , winnermembers}) => {
    ...
    <div className={`text-white ${winner || gallery ? "" : "hover:scale-105 duration-500"}  flex  flex-col-reverse  xl:flex-row p-4 border-t border-b border-[#1a8fdd] rounded-xl justify-around  gap-2 `}>
      <div className="w-[300px]  xl:w-[700px]">
        <div className="flex flex-col gap-2 justify-start">
          ...
          <h1 className="font-semibold text-slate-400 text-xl">Winners : {winners} </h1>
          <button onClick={openModal} className="bg-blue-500 text-white px-2 py-1 rounded-xl">View Winners</button>
          </div>
          <div>
