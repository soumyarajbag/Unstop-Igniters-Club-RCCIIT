...
const CellCard = () => {
 ...
 <div className='w-[320px] h-[500px]  gap-20 xl:w-[450px] xl:h-[450px]  border-t duration-150  hover:border-[#1a8fdd] bg-black z-0 rounded-lg'>
  <h1 className='relative left-[65%] top-[5%] md:left-[75%] text-[#1a8fdd] font-bold text-lg hover:text-opacity-60 cursor-pointer'>View Team</h1>
<div className='w-[320px]  xl:w-[450px] xl:h-[450px]  border-0 p-8 rounded-tr-full z-10 bg-[#0a2266] flex flex-col items-center'>
